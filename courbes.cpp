...
void createMenu()
{
    ...
    glutAddMenuEntry("Afficher (violet)", SUB_MENU_CURVE_BSPLINE_NON_UNIF);
    glutAddMenuEntry("Augmenter l'order", SUB_MENU_INCREASE_ORDER);

    glutCreateMenu(mainMenu);
    glutAddMenuEntry("Ajouter des points", MENU_ADD_POINT);
    glutAddMenuEntry("Deplacer des points", MENU_MOVE_POINT);
    glutAddMenuEntry("Courbe de Bezier (bleu)", MENU_CURVE_BEZIER);
    glutAddMenuEntry("Courbe de Catmull Rom (bleu clair) ", MENU_CURVE_CatmullRom);
    glutAddMenuEntry("Courbe B-Spline Uniforme (vert) ", MENU_CURVE_BSPLINE_UNIF);
    glutAddSubMenu("Courbe B-Spline Non Uniforme ", menuBSpline);
